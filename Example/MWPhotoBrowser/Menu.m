...
- (id)initWithCoder:(NSCoder *)aDecoder {
    if ((self = [super initWithCoder:aDecoder])) {
        ...
        _segmentedControl = [[UISegmentedControl alloc] initWithItems:@[@"Push", @"Modal"]];
        ...
        case 9: {
            @synchronized (_assets) {
                ...
                if (NSClassFromString(@"PHAsset")) {
                    ...
                    CGFloat imageSize = (CGFloat)(MAX(screen.bounds.size.width, screen.bounds.size.height) * 1.5);
                    CGSize imageTargetSize = CGSizeMake(imageSize * scale, imageSize * scale);
                    CGSize thumbTargetSize = CGSizeMake((CGFloat)(imageSize / 3.0 * scale), (CGFloat)(imageSize / 3.0 * scale));
